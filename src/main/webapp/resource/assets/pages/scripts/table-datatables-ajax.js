        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_ajax tr.interceptor .form-control").each(function() {
                ...
                // read the custom filters from saved state and populate the interceptor inputs
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "bStateSave": true, 
                 ...
                 // save custom filters to the state
                "fnStateSaveParams":    function ( oSettings, sValue ) {
                    $("#datatable_ajax_2 tr.interceptor .form-control").each(function() {
                        sValue[$(this).attr('name')] = $(this).val();
                    });
