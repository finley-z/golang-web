        ...
        return c.each(function () {
            ...
            var c = this,
                b = c.id, g = -p + "%", d = 100 + 2 * p + "%", d = {
                    ...
                    position: "absolute",
                    opacity: 0
                }, l = "checkbox" == c[_type] ? e.checkboxClass || "icheckbox" : e.radioClass || "i" + r, z = f(_label + '[for="' + b + '"]').add(a.closest(_label)), u = !!e.aria, y = m + "-" + Math.random().toString(36).substr(2, 6), h = '<div class="' + l + '" ' + (u ? 'authority="' + c[_type] + '" ' : "");
            u && z.each(function () {
                h +=
                    'aria-labelledby="';
