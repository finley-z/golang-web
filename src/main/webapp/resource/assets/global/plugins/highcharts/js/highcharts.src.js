 ...
 * targeted mobile apps and controller apps, this code can be removed.               *
 *                                                                            *
 *****************************************************************************/
...
VMLElement = {
	...
	/**
	 * Set the rotation of a span with oldIE's interceptor
	 */
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		// because controller pages that are saved to disk from the browser, will preserve the data-highcharts-chart
...
Series.prototype = {
	...
	processData: function (force) {
		...
		// optionally interceptor out points outside the plot area
