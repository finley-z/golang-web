...
rangy.createModule("TextRange", ["WrappedSelection"], function(api, module) {
    ...
    extend(positionProto, {
        ...
        /*
         Next and previous position moving functions that interceptor out
...
(function(wysihtml) {
  ...
  wysihtml.Selection = Base.extend(
    ...
    // If interceptor is defined nodes must pass the interceptor function with true to be included in list
