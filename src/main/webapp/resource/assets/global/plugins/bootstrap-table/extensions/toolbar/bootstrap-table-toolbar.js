...
!function($) {
    ...
    var showAvdSearch = function(pColumns, searchTitle, searchText, that) {
        if (!$("#avdSearchModal" + "_" + that.options.idTable).hasClass("modal")) {
            var vModal = sprintf("<div id=\"avdSearchModal%s\"  class=\"modal fade\" tabindex=\"-1\" authority=\"dialog\" aria-labelledby=\"mySmallModalLabel\" aria-hidden=\"true\">", "_" + that.options.idTable);
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        html.push(sprintf('<div class="columns columns-%s btn-group pull-%s" authority="group">', this.options.buttonsAlign, this.options.buttonsAlign));
