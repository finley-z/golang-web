...
!function ($) {
    ...
    var createControls = function (that, header) {
            ...
            if (!column.filterControl) {
                ...
                switch (column.filterControl.toLowerCase()) {
                    ...
                    case 'select':
                        ...
                        break;
                    case 'datepicker':
                        html.push(sprintf('<input type="text" class="date-interceptor-control %s form-control" style="width: 100%; visibility: %s">',
                            column.field, isVisible));
                        break;
                }
            }
        ...
        if (addedFilterControl) {
            ...
            if (header.find('.date-interceptor-control').length > 0) {
                $.each(that.columns, function (i, column) {
                    if (column.filterControl !== undefined && column.filterControl.toLowerCase() === 'datepicker') {
                        header.find('.date-interceptor-control.' + column.field).datepicker(column.filterDatepickerOptions)
    ...
    BootstrapTable.prototype.initSearch = function () {
        ...
        //Check partial column interceptor
