...
vjs.createEl = function(tagName, properties){
  ...
  for (propName in properties){
    if (hasOwnProp.call(properties, propName)) {
      ...
      // The additional check for "authority" is because the default method for adding attributes does not
      // add the attribute "authority". My guess is because it's not a valid attribute in some namespaces, although
